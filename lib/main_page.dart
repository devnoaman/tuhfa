...
Future <List> Category() async{
  final response = await http.get(Uri.parse('https://abualhassan.pythonanywhere.com/api/categories/get_all_categories'), headers:{"accept":"application/json"});
  var convertDatatoJson = jsonDecode(response.body);
  return convertDatatoJson;
}
Future <List> Calender() async{
  final response = await http.get(Uri.parse('https://abualhassan.pythonanywhere.com/api/schedule/retrieve_all_schedules'), headers:{"accept":"application/json"});
  var convertDatatoJson = jsonDecode(response.body);
  return convertDatatoJson;
}
        ...
        Container(
            ...
            child: ListView(
                children: <Widget>[
                  ...
                  SizedBox(height:7.0),
                  Center(
                      child:Text('الاقسام' , style: TextStyle(fontFamily: 'Cairo', color: Color.fromRGBO(147, 0, 15, 1.0), fontSize: 20.0, fontWeight: FontWeight.bold,),)
                  ),
                  SizedBox(height:7.0),
                  Container(
                    height: 200.0,
                  ...
                  SizedBox(height:7.0),
                  Center(
                      child:Text('الجدول الاسبوع' , style: TextStyle(fontFamily: 'Cairo', color: Color.fromRGBO(1, 85, 81, 1.0), fontSize: 20.0, fontWeight: FontWeight.bold,),)
                  ),
                  SizedBox(height:7.0),
 ...
 child:Row(
        ...
        child:  Column(
          ...
          children: [
            ...
            Text(title , style: TextStyle(fontFamily: 'Cairo', color: Color.fromRGBO(147, 0, 15, 1.0), fontSize: 20.0, fontWeight: FontWeight.bold,),)
          ],
        ),
      ),
            // Container(
  ...
  Widget calender(String day, String category, String date){
    ...
    return
      ...
      Container(
        ...
        child: Accordion(
          headerBackgroundColor: Color.fromRGBO(238, 237, 237, 0.4549019607843137),
          maxOpenSections: 50,
          // header: Text('Introduction', style: _headerStyle),
          leftIcon: Icon(Icons.calendar_today_outlined, color: Colors.black),
          rightIcon: Icon(Icons.keyboard_arrow_down, color: Colors.black,),
          children: [
            AccordionSection(
             // isOpen: true,
              leftIcon: Icon(Icons.calendar_today_outlined, color: Colors.black),
              header:  Text('${date} ${day} ' , style: TextStyle(fontFamily: 'Cairo', color: Color.fromRGBO(1, 85, 81, 1.0), fontSize: 18.0, fontWeight: FontWeight.bold,),),
              content: Wrap(
                children: [
                  Row(
                    children: [
